...
exports.getNotes = async (req,res)=>res.json(await Note.getNotesByUser(req.user.id));
...
exports.updateNote = async (req,res)=>{
 const c = await Note.updateNote(req.params.id,req.body.title,req.body.content,req.user.id);
